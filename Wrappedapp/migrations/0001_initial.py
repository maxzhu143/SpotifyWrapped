    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_token', models.CharField(help_text='The access token for Spotify API requests.', max_length=255)),
                ('refresh_token', models.CharField(help_text='The refresh token for renewing the access token.', max_length=255)),
                ('expires_at', models.DateTimeField(blank=True, null=True)),
                ('display_name', models.CharField(blank=True, help_text='Spotify display name of the linked account.', max_length=255, null=True)),
                ('spotify_id', models.CharField(blank=True, help_text='The unique Spotify ID for the account.', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personality_word', models.CharField(blank=True, max_length=255, null=True)),
